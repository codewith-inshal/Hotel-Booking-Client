...
function StaffRegister() {
  ...
  async function submitHandler(e) {
    ...
    try {
      ...
      toast.error(error.response?.data?.msg || "Failed to create staff");
    }
  }
      ...
      <div className="grid lg:grid-cols-2 max-w-6xl w-full overflow-hidden rounded-[2rem] shadow-2xl">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1528909514045-2fa4ac7a08ba?q=80&w=1600&auto=format&fit=crop')",
            }}
          ></div>
          ...
          <div className="relative z-10 text-white">
            ...
            <p className="text-gray-300 text-lg max-w-md">
              Create staff accounts for managing bookings and assisting guests.
            </p>
          </div>
        </motion.div>
          ...
          <div className="w-full">
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-500">
                Add hotel staff under admin control
              </p>
            </div>
